// Button Component - Reusable, accessible, with multiple variants
...
const variantStyles = {
  ...
  outline: 'border border-gray-300 text-gray-900 hover:bg-gray-50 active:bg-gray-100 focus:ring-gray-300',
  ghost: 'text-gray-900 hover:bg-gray-100 active:bg-gray-200 focus:ring-gray-200',
